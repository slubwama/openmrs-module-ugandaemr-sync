...
public class SyncDataRecord {
    ...
    public Map syncData(String syncRecord) throws Exception {
        ...
        try {
            ...
            return ugandaEMRHttpURLConnection.sendPostByWithBasicAuth(contentTypeXML, syncRecord, facilitySyncId, url, syncGlobalProperties.getGlobalProperty(SERVER_USERNAME), syncGlobalProperties.getGlobalProperty(SERVER_USERNAME));
