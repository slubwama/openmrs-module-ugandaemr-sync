...
public class ARTRegimenChangeTask extends AbstractTask {
    Log log = LogFactory.getLog(ARTRegimenChangeTask.class);
    @Override
    public void execute() {
        UgandaEMRSyncService ugandaEMRSyncService = Context.getService(UgandaEMRSyncService.class);
        SyncFhirProfile syncFhirProfile = ugandaEMRSyncService.getSyncFhirProfileByScheduledTaskName("ART Regimen Change");
