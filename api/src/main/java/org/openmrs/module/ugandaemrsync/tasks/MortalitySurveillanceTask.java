...
public class MortalitySurveillanceTask extends AbstractTask {

    Log log = LogFactory.getLog(MortalitySurveillanceTask.class);
    @Override
    public void execute() {
        UgandaEMRSyncService ugandaEMRSyncService = Context.getService(UgandaEMRSyncService.class);
        SyncFhirProfile syncFhirProfile = ugandaEMRSyncService.getSyncFhirProfileByScheduledTaskName("MORTALITY SURVEILLANCE");
