...
public class HIVExposedInfantDataTask extends AbstractTask {
    Log log = LogFactory.getLog(HIVExposedInfantDataTask.class);
    @Override
    public void execute() {
        UgandaEMRSyncService ugandaEMRSyncService = Context.getService(UgandaEMRSyncService.class);
        SyncFhirProfile syncFhirProfile = ugandaEMRSyncService.getSyncFhirProfileByScheduledTaskName("HIV Exposed Infant Data");
